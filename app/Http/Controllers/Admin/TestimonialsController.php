...
class TestimonialsController extends Controller
{
    ...
    public function index()
    {
        ...
        $posts = Post::where('type', 'testimonial')->with('excerpt', 'preview', 'banner')->latest()->paginate(20);
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'brand_avatar'  => 'nullable|image|max:1024',
        ]);
        ...
        try {
            ...
            if ($request->hasFile('brand_avatar')) {
                $banner = $this->saveFile($request, 'brand_avatar');
                $post->banner()->create([
                    'post_id' => $post->id,
                    'key'     => 'banner',
                    'value'   => $banner,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate([
            ...
            'testimonial.banner.value'  => 'nullable|image|max:1024',
        ]);
        ...
        try {
            ...
            if ($request->hasFile('testimonial.banner.value')) {
                $banner = $this->saveFile($request, 'testimonial.banner.value');
