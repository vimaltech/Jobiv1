            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5 col-md-6 ms-auto order-md-last">
                        ...
                        <p class="text-md">Can not find what you need? Take a moment and do a search below or start from our
                            Homepage.</p>
                        <a href="/" class="btn-one w-100 d-flex align-items-center justify-content-between mt-30">
                            <span>GO BACK</span>
                            <img src="{{ asset('assets/images/icon/icon_61.svg') }}" alt="">
                        </a>
                    </div>
                    <div class="col-md-6 order-md-first">
                        <img src="{{ asset('assets/images/assets/404.svg') }}" alt="" class="sm-mt-60">
                    </div>
                </div>
            </div>
        </div> 
